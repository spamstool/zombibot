...
print("[*] viper 1337 private Tool \n[*] ICQ :744289868\n\n")
print("""[viper1337] List Tools :
     ...
     [11] Cpanel detect and brute          [26] viper1337 shell detect and auto rooted very priv
     [12] Sitelist ip checker              [27] viper1337 inbox auto mail sender[Priv]
...
tools = raw_input("\n[viper1337] Select Use >>> ")

if tools == "1":
    dork = raw_input("[viper1337] Input Dork : ")
    if ' ' in dork:
        dork = dork.replace(' ', '+')
    else:
        pass
    dom = "com"
    out = raw_input("[viper1337] Input Output Dorking : ")
    scan(dork,dom,out)
elif tools == "2":
